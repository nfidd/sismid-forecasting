...
# Slides for this session
 ...
 - [From public health surveillance data to real-time decision support](slides/introduction-and-course-overview.qmd)
...
-   Have a more detailed look at the [learning objectives](../reference/learning_objectives.qmd) or the [class timetable](../timetable.qmd)

-   If you haven't already, install the needed software with [getting started with the course](../getting-started.qmd)

-   Once you're all set up, let's start with the first session on [forecasting concepts](forecasting-concepts.qmd).
