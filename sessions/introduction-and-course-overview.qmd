...
# Slides for this session
 ...
 - [From public health surveillance data to real-time decision support](slides/introduction-and-course-overview)
...
-   Have a more detailed look at the [learning objectives](../reference/learning_objectives) or the [class timetable](../timetable)

-   If you haven't already, install the needed software with [getting started with the course](../getting-started)
