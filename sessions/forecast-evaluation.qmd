...
-   The `copycat` analogue model, however, has the lowest CRPS at **every** horizon, and its advantage grows with horizon. Matching against whole past seasons lets it anticipate the peak and decline — and represent the uncertainty around them — better than extrapolating a parametric model.
