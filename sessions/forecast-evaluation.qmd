...
Sorted by CRPS, the `copycat` analogue model comes out on top: its *probabilistic* forecasts — which is what CRPS rewards — are the most accurate overall, and by a clear margin.
