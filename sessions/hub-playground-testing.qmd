...
You could create multiple flavors of ARIMA, or any of the more complex models suggested in the first session or in the [epidemiologically-motivated models](epi-motivated-forecasting.qmd).
...
Once you have selected your test-phase models, you can submit their forecasts to our [online `sismid-ili-forecasting-sandbox` hub](https://github.com/reichlab/sismid-ili-forecasting-sandbox).
