...
- Compare to observed truth with `hubEvals::score_model_out()` → **WIS**.

::: {.fragment .fade-in}
::: callout-caution
You forecast with **finalized** data; the hub's original models used data **as it was in real time**. Interpret head-to-head comparisons with care.
:::
:::
