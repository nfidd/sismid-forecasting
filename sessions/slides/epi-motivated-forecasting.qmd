...
Same structure: a weighted sum of past values plus an additive term.
The renewal fixes the weights to $R_t$ times the generation time, and its imports $\iota_t$ sit where the ARIMA has $\varepsilon_t$.
This is the deterministic renewal; fitting adds a negative binomial observation model on top.
