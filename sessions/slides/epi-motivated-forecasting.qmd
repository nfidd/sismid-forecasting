...
::: {.callout-note}
Reports lag infections, so the most recent days are still filling in and undercount recent infections.
A forecast that maps infections to reports through this delay starts from the right place; one that models the raw reports does not.
:::
...
The package is the engine; the model structure is what we have been building up.

### A population set too small

- Depletion takes hold too early
