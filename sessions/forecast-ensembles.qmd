...
As we saw in the sessions on [improving forecasting models](forecasting-models) and [forecast evaluation](forecast-evaluation), different modelling approaches have different strength and weaknesses, and we do not usually know in advance which one will produce the best forecast in any given situation.
