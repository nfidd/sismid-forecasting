...
::: callout-note
This course does **not** use Stan, so there is no need to install `cmdstan`.
(The companion [Nowcasting & $R_t$ estimation course](https://nfidd.github.io/sismid-nowcasting/) does use Stan.)
:::
