...
- [Sam Abbott](https://github.com/seabbs)
- [Mariah Boudreau](https://github.com/mariahcboudreau)
...
> SISMID course contributors (2025). SISMID: Forecasting & Evaluation of Infectious Disease Dynamics. Version [VERSION]. DOI: [PLACEHOLDER - Zenodo DOI will be added upon release]
...
```bibtex
@misc{sismid2025,
  author = {{Sam Abbott, Mariah Boudreau, Nick Reich}},
  title = {{SISMID: Forecasting & Evaluation of Infectious Disease Dynamics}},
  year = {2025},
  version = {[VERSION]},
  doi = {[PLACEHOLDER - Zenodo DOI]},
  url = {https://nfidd.github.io/sismid-forecasting/}
}
```
...
- [Report issues or suggest improvements](https://github.com/nfidd/sismid-forecasting/issues)
- [Join discussions](https://github.com/nfidd/sismid-forecasting/discussions)
- [Submit pull requests](https://github.com/nfidd/sismid-forecasting/pulls)
