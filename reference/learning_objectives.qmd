...
- familiarity with generation-time distributions and delay convolution from infections to reported cases
- understanding of susceptible depletion as a mechanism that bends the epidemic curve at the peak
- understanding the cost of a wrong mechanism: systematic, directional forecast errors
